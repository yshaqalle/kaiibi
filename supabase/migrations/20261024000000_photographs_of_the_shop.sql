...
-- price.
--
-- PATHS, NOT URLS, matching storefront_flyers.image_path exactly: uploadImage
-- returns what it returns, the column stores that, and publicImageUrl on the
-- client makes an address of it. Nothing downstream needs to know which bucket
-- a photograph lives in.
--
