...
const styles = StyleSheet.create({
  ...
  stack: { gap: 14 },
  clockStatus: { color: theme.bentoInk, fontSize: 17, fontWeight: '800', letterSpacing: -0.3 }, clockElapsed: { color: theme.bentoMuted, fontSize: 12, marginTop: 3 }, clockButton: { alignSelf: 'flex-start', marginTop: 14, backgroundColor: theme.bentoAccentSolid, borderRadius: 999, paddingHorizontal: 16, paddingVertical: 10 }, clockButtonDisabled: { opacity: 0.5 }, clockButtonText: { color: theme.bentoSurface, fontWeight: '800', fontSize: 12 }, error: { color: theme.bentoLoss, fontSize: 12, fontWeight: '700', marginTop: 10 },
  tiles: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 16 }, requestButton: { backgroundColor: theme.bentoAccentSolid, borderRadius: 999, paddingHorizontal: 13, paddingVertical: 7 }, requestButtonText: { color: theme.bentoSurface, fontSize: 11.5, fontWeight: '800' }, empty: { color: theme.bentoMuted, fontSize: 13, paddingVertical: 8 }, row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: theme.bentoLine }, rowText: { color: theme.bentoInk2, fontSize: 12, flexShrink: 1 }, duration: { color: theme.bentoInk, fontSize: 12, fontWeight: '700', fontVariant: ['tabular-nums'] }, reason: { color: theme.bentoMuted, fontSize: 11, marginTop: 2 }, requestActions: { flexDirection: 'row', gap: 6, alignItems: 'center' }, actionButton: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: theme.bentoSoft }, cancelButton: { backgroundColor: '#FCE9EB' }, actionText: { fontSize: 11, fontWeight: '700', color: theme.bentoInk2 }, cancelText: { color: '#B0293A' },
