...
export default function SignUpScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    <View style={styles.form}>
      ...
      {step === 2 && <><Text style={styles.formHeading}>Tell us about your shop</Text><Text style={styles.fieldLabel}>SHOP NAME</Text><TextInput value={shopName} onChangeText={setShopName} placeholder="Your shop name" placeholderTextColor="#89928B" style={styles.input}/></>}
