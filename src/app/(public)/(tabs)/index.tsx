      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.content, isDesktop && styles.contentDesktop]}>
        ...
        <View style={[styles.hero, isDesktop && styles.heroDesktop]}>
          <View style={styles.heroCopy}>
            <Text style={styles.eyebrow}>SHOP ONLINE IN HARGEISA</Text>
            <Text style={[styles.title, isDesktop && styles.titleDesktop]}>Shop local.{"\n"}Get it your way.</Text>
            <Text style={styles.subtitle}>Order from local shops online, then choose delivery to your door or pick up directly at the store.</Text>
          </View>
          {isDesktop && <View style={styles.heroStamp}><Text style={styles.stampBig}>DELIVERY</Text><Text style={styles.stampSmall}>or store{`\n`}pickup</Text></View>}
        </View>
        ...
        <View style={styles.fulfillmentBanner}>
          <Text style={styles.fulfillmentIcon}>▣</Text><View style={styles.fulfillmentCopy}><Text style={styles.fulfillmentTitle}>Shop online in Hargeisa</Text><Text style={styles.fulfillmentText}>Order from local shops, then choose delivery or pick up directly from the store.</Text></View>
        </View>
        ...
        <View style={styles.shopCallout}><Text style={styles.calloutLabel}>ARE YOU A SHOP OWNER?</Text><Text style={styles.calloutTitle}>Your shop belongs here.</Text><Text style={styles.calloutText}>Build your catalog, track what is selling, and meet new customers.</Text><Pressable onPress={() => router.push('/signup')} accessibilityRole="link"><Text style={styles.calloutLink}>Create a shop account  →</Text></Pressable></View>
      </ScrollView>
    </SafeAreaView>
  );
}
